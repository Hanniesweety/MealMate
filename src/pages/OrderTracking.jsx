        ...
        <div className="ot-container">
              ...
              {steps.map((step, index) => (
                <div key={step.id} className="ot-step-wrap">
                  ...
                  >
                    ...
                    {isCurrent(step.id) &&
                      currentStep < 4 && (
                        <div className="ot-pulse"></div>
                      )}
                  </div>

                  {index < steps.length - 1 && (
                    <div
                      className={`ot-connector ${
                        isActive(step.id + 1)
                          ? "filled"
                          : ""
                      }`}
          ...
          {currentStep === 3 && (
            <div className="ot-rider-card">
              ...
              <div className="ot-rider-left">
                <div className="ot-rider-avatar">
                  🧑‍🦱
                </div>

                <div>
                  <div className="ot-rider-name">
                    Ravi Kumar
                  </div>

                  <div className="ot-rider-sub">
          ...
          {currentStep === 4 && (
            <div className="ot-delivered-card">
              ...
              <div className="ot-delivered-icon">
                🎉
              </div>
